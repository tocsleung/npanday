...
import npanday.plugin.libraryimporter.LibraryImporterLifecycleMap
...
LifecycleConfigurationGenerator
		.persistAllTypesAndLifecycles(LibraryImporterLifecycleMap, project.version, componentsXmlFile)
